...
const instituteCollectionName = process.env.INSTITUTE_COLLECTION_NAME ||  'Institute'
const submissionsCollectionName = process.env.SUBMISSION_COLLECTION_NAME ||  'Submission'
